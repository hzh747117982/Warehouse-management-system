...
export default {
  ...
  methods: {
    ...
    loadGet() {
      this.$axios.post('http://localhost:8088/goodstype/listPage', {
    ...
    save() {
      this.$refs.form.validate((valid) => {
        if (valid) {
          this.$axios.post('http://localhost:8088/goodstype/saveOrMod', this.form).then(res => res.data).then(res => {
            console.log(res.data)
            if (res.code === 200) {
              this.tableData = res.data
              this.total = res.total
    ...
    del(id){
      this.$axios.get('http://localhost:8088/goodstype/delete?id='+id).then(res => res.data).then(res => {
        console.log(res.data)
        if (res.code === 200) {
          this.tableData = res.data
          this.total = res.total
